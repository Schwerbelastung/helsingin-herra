...
const Properties = (() => {
    ...
    const PROPERTY_QUIRKS = {
        retail: [
            "The previous owner once refused to sell to IKEA. Twice.",
            "A regular customer has visited every single day since 1987.",
            "The loading dock faces north. Staff say this is very important.",
            "Helsinki's first credit card transaction took place here in 1982.",
            "Moomin merchandise was briefly banned from this shop. Nobody knows why.",
            "The basement contains an elaborate model railway no one has touched since 1994.",
            "A customer once left a live reindeer tied to the door. The police were baffled.",
            "The shop radio has been tuned to the same station since it opened.",
            "Three Finnish presidents have bought something here, though none will confirm it.",
            "There is a permanent indentation in the floor where the longest-ever queue once stood.",
            "All staff must pass a Finnish silence test before being hired.",
            "The original price tags are still in the archive. They are deeply upsetting.",
            "Rumoured to be built on the site of Helsinki's worst-ever parking dispute.",
            "The fire exit leads directly into a sauna. This has never been explained.",
            "The ghost of a disgruntled cashier is said to reorganise shelves overnight.",
        ],
        restaurant: [
            "Tove Jansson allegedly ate here every Thursday for three years.",
            "The head chef once cooked for a Finnish president and refuses to discuss it.",
            "The sauna here allegedly reaches 110°C. The health inspector has been informed.",
            "A single table in the corner has been reserved every Friday since 1976. By whom, nobody asks.",
            "The recipe for the house meatballs is legally protected and stored in a bank vault.",
            "Linus Torvalds is said to have debugged his first kernel over coffee here.",
            "The wine list has not changed since 1991. The sommelier considers this a feature.",
            "The kitchen once survived a full power cut by switching to candlelight. Service continued.",
            "A Finnish-Swedish argument broke out here in 1988 and technically never ended.",
            "The longest known lunch break in Helsinki history took place in this establishment.",
            "Staff are contractually forbidden from commenting on the soup.",
            "The restaurant cat has never been photographed. Many have tried.",
            "The original menu featured seventeen varieties of porridge. Only one remains.",
            "A proposal of marriage occurs here on average 2.3 times per month.",
            "The building's ventilation system plays a faint note of E-flat at all times.",
        ],
        hotel: [
            "A minor Scandinavian royal once stayed in room 14. The plaque was removed at their request.",
            "The hotel switchboard still receives calls for a guest who checked out in 1969.",
            "Every room above the third floor faces a different compass direction. By accident.",
            "A Finnish diplomat once lived here for eleven years while 'between apartments.'",
            "The breakfast buffet holds the Finnish record for most herrings consumed before 8am.",
            "Rumour has it the sauna was used for contract negotiations in the 1980s.",
            "The lift has been stuck between floors 3 and 4 a statistically implausible number of times.",
            "A guest once left behind 47 Nokia phones. The box is still in lost property.",
            "The night porter has worked every shift since 1993. He does not discuss this.",
            "An unconfirmed ice hockey legend spent his entire playoff earnings here in one weekend.",
            "The wallpaper in suite 201 was designed by a Finnish architect who later denied it.",
            "The minibar has never been fully restocked. Management calls this 'curated scarcity.'",
            "Three different guests have independently left the same book in room 11.",
            "The hotel cat has formal check-in records going back to 1981.",
            "Local legend holds that anyone who stays in room 7 dreams in Finnish, regardless of nationality.",
        ],
        office: [
            "Nokia once held an emergency board meeting here on a Sunday. The outcome is classified.",
            "The building has 47 light switches. Only 31 have a known function.",
            "A startup founded in this building was acquired for €80M. The founders bought a boat.",
            "The meeting room on floor 4 is said to be where Finland's first PowerPoint was shown.",
            "All the plants are artificial but staff water them anyway.",
            "The building faces magnetic north within 0.3 degrees. The architect claims this was intentional.",
            "A single ethernet cable runs from the server room to an unknown destination.",
            "The coffee machine has processed an estimated 140,000 cups since installation.",
            "Floor 2 smells faintly of cardamom. No source has ever been located.",
            "The fire drill record for this building stands at 4 minutes 12 seconds, set in 2009.",
            "An anonymous tip once led investigators here. Nothing was found. The tip remains unexplained.",
            "The basement printing room is believed to be the birthplace of Finland's first tech unicorn pitch deck.",
            "All four previous tenants have gone on to be acquired. Local investors call it the golden corridor.",
            "The building's Wi-Fi password has never been changed. It is a Finnish word for 'silence.'",
            "A motivational poster on floor 3 has not been updated since 2006. Nobody removes it.",
        ],
        residential: [
            "A local legend says this building is haunted by a tonttu who moves keys.",
            "The heating system was designed by an engineer who fled to Sweden in 1962. It still works.",
            "The longest-tenured resident has lived here since the building opened and knows everyone's business.",
            "Every window faces away from the sunrise. The architect called this 'intentional calm.'",
            "The post boxes have never been relabelled. Three previous residents still receive mail here.",
            "A tonttu sighting was formally reported to the building committee in 1998. Minutes survive.",
            "Residents hold a sauna night on the last Thursday of each month. Non-residents are not invited.",
            "The stairwell has the best acoustics of any building in the district, according to no one in particular.",
            "An urban myth claims the basement contains a hidden sauna from the 1950s. It does.",
            "Nobody uses the second elevator. Nobody discusses this.",
            "The building holds the neighbourhood record for most Moomin ornaments per square metre.",
            "A neighbour dispute over a parking space here lasted 14 years. It was resolved by lottery.",
            "The building committee minutes from 1987 are said to contain a surprisingly detailed prediction of the internet.",
            "Previous tenants include a retired icebreaker captain, three architects, and a competitive orienteer.",
            "The balcony on floor 5 has the best view of the sea in the building. Only one tenant has ever used it.",
        ],
        landmark: [
            "A Finnish president once got briefly lost inside and refused to ask for directions.",
            "An urban explorer documented every room here in 2003. The photos have never been published.",
            "The building's shadow falls on the same cobblestone every summer solstice at noon.",
            "Restoration workers in 1991 found a bottle of koskenkorva sealed inside the east wall.",
            "The architect is said to have cried at the opening ceremony, for undisclosed reasons.",
            "A time capsule was placed in the foundation in 1955. No one remembers what's in it.",
            "Three different films have been shot here. All three are Finnish. None are widely seen.",
            "Helsinki's most photographed lamppost stands directly outside. It has its own fan page.",
            "The building once appeared on a postage stamp. Collectors pay dearly for misprints.",
            "Local schoolchildren have been drawing this building on the same assignment since 1971.",
            "A guided tour here once accidentally included a live board meeting. Nobody stopped it.",
            "The stone steps show wear patterns consistent with approximately four million footsteps.",
            "A minor historical event occurred here in 1923. Historians disagree on its significance.",
            "The original blueprints show a fourth floor that was never built. Nobody knows why.",
            "Jean Sibelius is rumoured to have walked past this building while humming. It cannot be confirmed.",
        ],
    };

    function getRandomQuirk(propertyType) {
        const pool = PROPERTY_QUIRKS[propertyType] || PROPERTY_QUIRKS.retail;
